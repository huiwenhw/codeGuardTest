...
public class GrepApplicationTest {
	...
	private static final String NOMATCH = "Pattern not found";
	...
	public void grepStdInNoMatches() throws GrepException {
		...
		args[0] = HIEPATTERN;
		assertEquals(NOMATCH, grepApp.grepFromStdin(args[0], stdin));
	}
	...
	public void grepSingleFileNoMatches() throws GrepException {
		...
		args[0] = HIEPATTERN;
		args[1] = fileName;
		assertEquals(NOMATCH, grepApp.grepFromOneFile(args[0] + " " + args[1]));
	}
	...
	public void grepMultipleFileNoMatches() throws GrepException {
		...
		args[1] = fileName;
		args[2] = fileName2;
		assertEquals(NOMATCH, grepApp.grepFromOneFile(args[0] + " " + args[1] + " " + args[2]));
	}
	...
	public void grepMultipleFileInvalidMatches() throws GrepException {
		...
		args[2] = fileName;
		args[3] = fileName2;
		assertEquals(cannotReadFrom(invalidFile) + "ABCDEFGHI\nDEF",
				grepApp.grepFromMultipleFiles(args[0] + " " + args[1] + " " + args[2] + " " + args[3]));
	}
	...
	/*
	 * @Test public void grepUnorderedInput1FromRun() throws GrepException {
	 * args = new String[3]; args[0] = fileName; args[1] = REGEXPATTERN; args[2]
	 * = fileName2; grepApp.run(args, stdin, System.out); System.out.flush();
	 * assertEquals(REGEXMULTIOUT + "\n", baos.toString()); }
	 * 
	 * @Test public void grepUnorderedInput2FromRun() throws GrepException {
	 * args = new String[3]; args[0] = fileName; args[1] = fileName2; args[2] =
	 * REGEXPATTERN; grepApp.run(args, stdin, System.out); System.out.flush();
	 * assertEquals(REGEXMULTIOUT + "\n", baos.toString()); }
	 */
	...
	/*
	 * @Test(expected = GrepException.class) public void
	 * grepNoPatternFileFromRun() throws GrepException { args = new String[1];
	 * args[0] = fileName; grepApp.run(args, stdin, System.out);
	 * System.out.flush(); }
	 * 
	 * @Test(expected = GrepException.class) public void
	 * grepNoPatternMultipleFileFromRun() throws GrepException { args = new
	 * String[2]; args[0] = fileName; args[1] = fileName2; grepApp.run(args,
	 * stdin, System.out); System.out.flush(); }
	 */
	...
	public void grepDirectoryFromRun() throws GrepException {
		...
		grepApp.run(args, stdin, System.out);
		System.out.flush();
		assertEquals(cannotReadFrom(directory), baos.toString());
	}

	/*
	 * @Test(expected = GrepException.class) public void
	 * grepMultiplePatternFromRun() throws GrepException { args = new String[3];
	 * args[0] = REGEXPATTERN; args[1] = ABCPATTERN; args[2] = fileName;
	 * grepApp.run(args, stdin, System.out); System.out.flush(); }
	 */

	@Test
	public void invalidRegexInFile() throws GrepException {
		args = new String[3];
		args[0] = "[";
		args[1] = fileName2;
		args[2] = fileName;
		assertEquals("Invalid Pattern", grepApp.grepInvalidPatternInFile(args[0]));
	}

	@Test
	public void invalidRegexInStdin() throws GrepException {
		args = new String[3];
		args[0] = "[";
		args[1] = fileName2;
		args[2] = fileName;
		assertEquals("Invalid Pattern", grepApp.grepInvalidPatternInStdin(args[0]));
	}
	...
	private String cannotReadFrom(String input) {
